        ...
        <div className='space-y-8 w-full max-w-md'>
          ...
          <div className='mb-8 text-center'>
            <div className='group flex flex-col items-center gap-2'>
              <div className='group-hover:bg-primary/20 flex justify-center items-center bg-primary/10 rounded-xl size-12 transition-colors'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <button type='submit' className='w-full btn btn-primary' disabled={isSigningUp}>
              { isSigningUp ? <><Loader2 className='size-5 animate-spin'/>Loading...</> : "Create an account" }
            </button>
          </form>
